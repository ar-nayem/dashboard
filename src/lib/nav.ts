...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/repos", label: "Repos", icon: "M9 4.5 4.5 9l4.5 4.5M15 4.5 19.5 9l-4.5 4.5M13.5 3.5l-3 17" },
  { href: "/linkedin", label: "LinkedIn", icon: "M4.5 4.5h15v15h-15zM7.5 10.5v6M7.5 7.75v.01M11.5 16.5v-4a2 2 0 0 1 4 0v4M11.5 12.5v4" },
  ...
  { href: "/work", label: "Work", icon: "M4 7.5h16v11H4zM8 7.5V5.5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M4 12h16" },
  { href: "/blog", label: "Blog", icon: "M6 3.5h9L19 7.5v13H6zM13 3.5V8h5.5M9 13h6M9 16.5h6" },
  { href: "/services", label: "Services", icon: "M12 3.5l2.6 5.3 5.9.8-4.3 4.1 1 5.8-5.2-2.7-5.2 2.7 1-5.8-4.3-4.1 5.9-.8Z" },
  { href: "/faq", label: "FAQ", icon: "M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z M9.5 9a2.5 2.5 0 1 1 3.5 2.3c-.7.3-1 .8-1 1.5v.4 M12 16.5h.01" },
